...
#define SCCB_SCL_CLK_ENABLE       __HAL_RCC_GPIOD_CLK_ENABLE()		// SCL 引脚时钟
#define SCCB_SCL_PORT   		   GPIOD                 				// SCL 引脚端口
#define SCCB_SCL_PIN     		   GPIO_PIN_4  							// SCL 引脚
        
#define SCCB_SDA_CLK_ENABLE       __HAL_RCC_GPIOD_CLK_ENABLE() 	// SDA 引脚时钟
#define SCCB_SDA_PORT   			 GPIOD                   			// SDA 引脚端口
#define SCCB_SDA_PIN    			 GPIO_PIN_5              			// SDA 引脚
